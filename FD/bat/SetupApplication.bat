...
:: Android packaging
set AND_CERT_NAME="exVideoPlayer"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\exVideoPlayer.p12
...
set IOS_PROVISION=cert\comdoitflashexVideoPlayer.mobileprovision
...
set IOS_DIST_SIGNING_OPTIONS=-hideAneLibSymbols yes -storetype pkcs12 -keystore "%IOS_DIST_CERT_FILE%" -provisioning-profile %IOS_PROVISION%
...
set APP_ID=com.doitflash.exVideoPlayer

:: Output packages
set DIST_PATH=dist
set DIST_NAME=exVideoPlayer
